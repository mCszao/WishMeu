...
class WishList extends Model {
    public static function loadCompleteLists(){
        return WishList::select(['wishlists.name', 'wishlists.description', 'i.name', 'i.observations', 'itl.min_value', 'itl.max_value', 'itl.payed_value', 'itl.conclued'])->innerJoin('itemtolists as itl', 'itl.id_list', '=', 'wishlists.id')->join('items as i', 'i.id', '=', 'itl.id_item')->get();
    }
